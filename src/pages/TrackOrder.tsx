...
// import { useGetSingleUserOrdersQuery } from "@/redux/features/order/orderApi";
...
//   // Get the latest order status (assuming we're tracking the most recent order)
//   const latestOrder = ordersData?.data?.[0];
//   const orderStatus = latestOrder?.orderStatus || "pending";
