...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Cart Dialog */}
      {isCartDialogOpen && (
        <div className="fixed top-0 right-0 m-4 w-80 bg-white shadow-lg rounded-lg overflow-auto z-50">
          <button
            onClick={() => setIsCartDialogOpen(false)}
            className="absolute top-2 right-2 text-gray-600 hover:text-[#3712c2] transition-colors duration-300"
          >
            <X className="w-6 h-6" />
          </button>
