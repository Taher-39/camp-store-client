...
const AboutUsPage = () => {
  ...
  return (
    <div className="container mx-auto py-8">
      {isLoading ? (
        // Display loading spinner in the center while loading
        ...
        <div className="mx-auto w-[90%]">
          ...
          <section className="mb-8">
            ...
            <p>
              At CampStore, our mission is to provide high-quality camping gear
              and outdoor products that inspire adventure and help our customers
              connect with nature.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="text-center">
                ...
                <p className="mt-2">
                  Abu Taher is passionate about the outdoors and started
                  CampStore to share his love for adventure with others.
                </p>
              </div>
              <div className="text-center">
                <img
                ...
                <p className="mt-2">
                  Jane is an experienced marketer who brings creativity and a
                  deep understanding of the outdoor industry to the team.
                </p>
              </div>
            </div>
          </section>
